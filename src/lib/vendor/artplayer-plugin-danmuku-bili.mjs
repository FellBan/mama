/*!
 * artplayer-plugin-danmuku.js v5.2.0
...
!(function (e, t, i, a, n, o, s, l) {
  ...
  (m.isParcelRequire = !0),
    (m.Module = function (e) {
      (this.id = e), (this.bundle = m), (this.require = h), (this.exports = {});
    }),
    (m.modules = e),
    (m.cache = u),
    (m.parent = d),
...
})(
  {
    '7ICE7': [
      function (e, t, i, a) {
        ...
        function u(e) {
          return (t) => {
            let i = new (0, s.default)(t, e),
              a = new (0, p.default)(t, i);
            return (
              i.option.heatmap && (0, r.default)(t, i, i.option.heatmap),
              {
        ...
        (u.icons = p.default.icons),
          'undefined' != typeof window && (window.artplayerPluginDanmuku = u);
      },
      {
        './danmuku': '9bpce',
        './heatmap': '9KNY2',
        ...
        class r {
          constructor(e, t) {
            ...
            (this.utils = i.utils),
              ...
              this.config(t, !0);
            let n = new Blob([s.default.replace('export{e as default};', '')], {
          ...
          get marginTop() {
            ...
            return 'number' == typeof t
              ...
              ? e(i * (Number.parseFloat(t) / 100), 0, i)
              : r.option.margin[0];
          }
          get marginBottom() {
            let { clamp: e } = this.utils,
          ...
          get fontSize() {
            ...
            return 'number' == typeof i
              ...
              ? Math.round(e(t * (Number.parseFloat(i) / 100), 12, t))
              : r.option.fontSize;
          }
          get $ref() {
          ...
          async load(e) {
            ...
            try {
              'function' == typeof a
                ...
                : Array.isArray(a) && (i = a),
                t(Array.isArray(i), 'Danmuku need return an array as result'),
                void 0 === e &&
                  (this.reset(),
                  (this.queue = []),
                  (this.states = { wait: [], ready: [], emit: [], stop: [] }),
              ...
              throw (this.art.emit('artplayerPluginDanmuku:error', e), e);
            }
            return this;
          }
          async emit(e) {
          ...
          config(e, t = !1) {
            ...
            return (
              (Object.keys(e).some(
                (t) => JSON.stringify(this.option[t]) !== JSON.stringify(e[t])
              ) ||
                t) &&
                ((this.option = Object.assign({}, r.option, this.option, e)),
            ...
            return (
              this.filter('emit', (t) => {
                if ((this.setState(t, 'stop'), 0 === t.mode)) {
                  let i =
                    e - (this.getLeft(t.$ref) - this.getLeft(this.$player));
                  (t.$ref.style.transform = `translateX(${-i}px)`),
        ...
        function r(e) {
          return new Promise(async (t) => {
            ...
            try {
              ...
              console.error('Error parsing Bilibili Danmu:', e), t(s(a));
            }
          });
        }
        n.defineInteropFlag(i),
            ...
            mounted(n) {
              ...
              function r(d = []) {
                if (
                  ...
                  return;
                let p = { w: n.offsetWidth, h: n.offsetHeight },
                  u = {
                    xMin: 0,
                    xMax: p.w,
                    yMin: 0,
                    ...
                    scale: 0.25,
                    opacity: 0.2,
                    minHeight: Math.floor(0.05 * p.h),
                    sampling: Math.floor(p.w / 100),
                    smoothing: 0.2,
                    flattening: 0.2,
                  };
                'object' == typeof i && Object.assign(u, i);
                let h = [];
                if (Array.isArray(d) && d.length) h = [...d];
                else {
                  let i = e.duration / p.w;
                  for (let e = 0; e <= p.w; e += u.sampling) {
                    let a = t.queue.filter(
                      ({ time: t }) => t > e * i && t <= (e + u.sampling) * i
                    ).length;
                    h.push([e, a]);
                  }
                }
                ...
                c !== p.w && h.push([p.w, f]);
                let g = h.map((e) => e[1]),
                  y = (Math.min(...g) + Math.max(...g)) / 2;
                for (let e = 0; e < h.length; e++) {
                  let t = h[e],
                    i = t[1];
                  t[1] = i * (i > y ? 1 + u.scale : 1 - u.scale) + u.minHeight;
                }
                let v = (e, t, i, a) => {
                    let n = (function (e, t) {
                        let i = t[0] - e[0],
                          a = t[1] - e[1];
                        return {
                          length: Math.sqrt(i ** 2 + a ** 2),
                          angle: Math.atan2(a, i),
                        };
                      })(t || e, i || e),
                      s = o.map(Math.cos(n.angle) * u.flattening, 0, 1, 1, 0),
                      l = n.angle * s + (a ? Math.PI : 0),
                      r = n.length * u.smoothing;
                    return [e[0] + Math.cos(l) * r, e[1] + Math.sin(l) * r];
                  },
                  x = h
                    .map((e) => [
                      o.map(e[0], u.xMin, u.xMax, 0, p.w),
                      o.map(e[1], u.yMin, u.yMax, p.h, 0),
                    ])
                    .reduce(
                      (e, t, i, a) =>
                        0 === i
                          ? `M ${a[a.length - 1][0]},${p.h} L ${t[0]},${
                              p.h
                            } L ${t[0]},${t[1]}`
                          : `${e} ${((e, t, i) => {
                              let a = v(i[t - 1], i[t - 2], e),
                                n = v(e, i[t - 1], i[t + 1], !0),
                                o = t === i.length - 1 ? ' z' : '';
                              return `C ${a[0]},${a[1]} ${n[0]},${n[1]} ${e[0]},${e[1]}${o}`;
                            })(t, i, a)}`,
                      ''
                    );
                (n.innerHTML = `<svg viewBox="0 0 ${p.w} ${p.h}"><defs><linearGradient id="heatmap-solids" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" style="stop-color:var(--art-theme);stop-opacity:${u.opacity}" /><stop offset="0%" style="stop-color:var(--art-theme);stop-opacity:${u.opacity}" id="heatmap-start" /><stop offset="0%" style="stop-color:var(--art-progress-color);stop-opacity:1" id="heatmap-stop" /><stop offset="100%" style="stop-color:var(--art-progress-color);stop-opacity:1" /></linearGradient></defs><path fill="url(#heatmap-solids)" d="${x}"></path></svg>`),
                  (s = a('#heatmap-start', n)),
                  (l = a('#heatmap-stop', n)),
    ...
    '94xSe': [
      function (e, t, i, a) {
        ...
        var o = e('bundle-text:./img/check_off.svg'),
          ...
          k = n.interopDefault(x),
          b = e('bundle-text:./img/mode_2_on.svg'),
          $ = n.interopDefault(b),
          w = e('bundle-text:./img/off.svg'),
          M = n.interopDefault(w),
          D = e('bundle-text:./img/on.svg'),
          S = n.interopDefault(D),
          E = e('bundle-text:./img/style.svg'),
          T = n.interopDefault(E),
          q = e('bundle-text:./style.less'),
          A = n.interopDefault(q);
        if (
          ((i.default = class {
            constructor(e, t) {
              (this.art = e),
            ...
            get TEMPLATE() {
              let { option: e } = this;
              return `<div class="apd-toggle">${S.default}${
                M.default
            ...
            createEvents() {
              ...
              this.art.proxy(e, 'click', () => {
                ...
                this.art.proxy(l, 'keypress', (e) => {
                  'Enter' === e.key && (e.preventDefault(), this.emit());
                });
            }
            createSliders() {
            ...
            createSlider({
              ...
              r(i, 'touch-action', 'none'),
                (i.innerHTML = `<div class="apd-slider-line"><div class="apd-slider-points">${o
                  ...
                  .map((e) =>
                    e.hide ? '' : `<div class="apd-slider-step">${e.name}</div>`
                  )
                  .join('')}</div>`);
              ...
              function m(a) {
                ...
                this.art.isRotate
                  ? h(Math.round((l(a.clientY - n, 0, o) / o) * (t - e) + e))
                  : h(Math.round((l(a.clientX - s, 0, r) / r) * (t - e) + e));
              }
              return (
                this.art.proxy(i, 'click', (e) => {
                  m.call(this, e);
            ...
            lock() {
              ...
              let a = () => {
                this.timer = setTimeout(() => {
                  0 === i ? this.unlock() : ((t.textContent = i -= 1), a());
                }, 1e3);
              };
              a();
            }
            ...
            resize() {
              if (this.outside || this.art.fullscreen || this.art.fullscreenWeb)
                return;
              let { $player: e, $controlsCenter: t } = this.art.template,
                { $danmuku: i } = this.template;
            ...
            reset() {
              ...
              let n = Array.from(a.children).find(
                (e) => e.dataset.color === this.option.color.toUpperCase()
              );
              n && e(n, 'apd-active'),
...
let { default: e } = parcelRequire4dc0('7ICE7');
export { e as default };
